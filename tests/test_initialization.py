...
def test_find_initial_wave_not_yet_confirmed_on_prefix():
    ...
    h0 = Pivot(pivot_type=PivotType.H, price=110, extreme_bar_dt="d02", confirm_bar_dt="d04", confirm_price=100)
    l1 = Pivot(pivot_type=PivotType.L, price=96, extreme_bar_dt="d05", confirm_bar_dt="d07", confirm_price=100)
...
def test_find_initial_wave_waits_when_h2_does_not_exceed_h0():
    ...
    h0 = Pivot(pivot_type=PivotType.H, price=110, extreme_bar_dt="d02", confirm_bar_dt="d04", confirm_price=100)
    l1 = Pivot(pivot_type=PivotType.L, price=96, extreme_bar_dt="d05", confirm_bar_dt="d07", confirm_price=100)
    h_a = Pivot(pivot_type=PivotType.H, price=105, extreme_bar_dt="d08", confirm_bar_dt="d10", confirm_price=100)
    h_b = Pivot(pivot_type=PivotType.H, price=114, extreme_bar_dt="d12", confirm_bar_dt="d14", confirm_price=100)
...
def test_find_initial_wave_down_direction_implemented():
    ...
    l0 = Pivot(pivot_type=PivotType.L, price=100, extreme_bar_dt="d00", confirm_bar_dt="d02", confirm_price=100)
    h1 = Pivot(pivot_type=PivotType.H, price=115, extreme_bar_dt="d03", confirm_bar_dt="d05", confirm_price=110)
    l2 = Pivot(pivot_type=PivotType.L, price=95, extreme_bar_dt="d05", confirm_bar_dt="d07", confirm_price=100)
...
def test_find_initial_wave_h0_replacement_implemented():
    ...
    h0 = Pivot(pivot_type=PivotType.H, price=110, extreme_bar_dt="d02", confirm_bar_dt="d04", confirm_price=105)
    h_higher = Pivot(pivot_type=PivotType.H, price=120, extreme_bar_dt="d05", confirm_bar_dt="d07", confirm_price=115)
    l1 = Pivot(pivot_type=PivotType.L, price=96, extreme_bar_dt="d08", confirm_bar_dt="d10", confirm_price=100)
    h2 = Pivot(pivot_type=PivotType.H, price=125, extreme_bar_dt="d11", confirm_bar_dt="d13", confirm_price=120)
...
def test_find_initial_wave_l1_replacement_implemented():
    ...
    h0 = Pivot(pivot_type=PivotType.H, price=110, extreme_bar_dt="d02", confirm_bar_dt="d04", confirm_price=105)
    l1 = Pivot(pivot_type=PivotType.L, price=96, extreme_bar_dt="d05", confirm_bar_dt="d07", confirm_price=100)
    l_lower = Pivot(pivot_type=PivotType.L, price=90, extreme_bar_dt="d08", confirm_bar_dt="d10", confirm_price=95)
    h2 = Pivot(pivot_type=PivotType.H, price=115, extreme_bar_dt="d11", confirm_bar_dt="d13", confirm_price=110)
